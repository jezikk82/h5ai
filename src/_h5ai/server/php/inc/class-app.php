...
class App {
	...
	public function get_fallback() {
		...
		$html .= "<tr>";
		if(!$this->options["view"]["suppressicon"]) $html .= "<th class='fb-i'></th>";
		$html .= "<th class='fb-n'><span>Name</span></th>";
		if(!$this->options["view"]["suppresslastmodified"]) $html .= "<th class='fb-d'><span>Last modified</span></th>";
		if(!$this->options["view"]["suppresssize"]) $html .= "<th class='fb-s'><span>Size</span></th>";
		$html .= "</tr>";

		if ($folder->get_parent($cache)) {
			$html .= "<tr>";
			if(!$this->options["view"]["suppressicon"]) $html .= "<td class='fb-i'><img src='" . APP_HREF . "client/images/fallback/folder-parent.png' alt='folder-parent'/></td>";
			$html .= "<td class='fb-n'><a href='..'>Parent Directory</a></td>";
			if(!$this->options["view"]["suppresslastmodified"]) $html .= "<td class='fb-d'></td>";
			if(!$this->options["view"]["suppresssize"]) $html .= "<td class='fb-s'></td>";
			$html .= "</tr>";
		}
